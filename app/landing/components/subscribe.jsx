    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-4 w-full  items-center justify-around">
        <input
          ...
          className="w-[100%] md:w-[45%] h-[60px] border-2 border-orange-400 rounded-lg px-4 text-gray-500 shadow-md focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-orange-400"
        />
        <input
          type="text"
