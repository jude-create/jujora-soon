  ...
  return (
    <section>
      <div className="flex flex-col items-center w-screen">
        ...
        <h1 className=" mx-auto text-2xl md:text-3xl text-center">
          What our clients say about us!
        </h1>

        <div className="w-[80%] md:w-full flex flex-col md:flex-row justify-around items-center my-20 gap-20 md:gap-0">
          {testimonials_color.map((e) => (
            <div
              key={e}
              className="relative md:w-96 p-8 rounded-lg shadow-lg"
